...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/aeolus-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11217&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/aeolus-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `aeolus` can be installed with:

```
conda install aeolus
```

It is possible to list all of the versions of `aeolus` available on your platform with:
